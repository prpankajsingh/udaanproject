...
import { auth } from "../Store Features/firebase";
function SignIn() {
  ...
  return (
    <div className="signin">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="signinformerrors">
          {errors.Email?.type === "required" && "Email is required"}
        </div>
        <div className="signintopitem2">
          <input
            type="password"
        ...
        <div onClick={sendPasswordResetEmail} className="signintopitem3">
          {t("signup_forgot")}
        </div>
        <button type="submit">{t("signup_button2")}</button>
      </form>
      <div className="signinbottom_item1">
        <div className="signinlines"></div>
        <p className="signinbottomtext">{t("signup_or")}</p>
        <div className="signinlines"></div>
      </div>
      <div className="signin_social_provider">
        <div onClick={signInWithGoogle} className="signin_social_provider_item">
          <svg
            width="53"
            height="53"
            viewBox="0 0 73 73"
          ...
          <p className="signin_provider_text">
            {t("signup_social_provider")} Google
          </p>
        </div>
        <div className="signin_social_provider_item">
          <svg
            width="53"
            height="53"
            viewBox="0 0 73 73"
      ...
      <div className="signin_bottom_footer">
        <div className="signinlinesfooter"></div>
        <p className="signin_bottom_footer_text">{t("signup_account")}</p>
        <div className="signinlinesfooter"></div>
      </div>
      <div className="signin_footer_button">
        <button
          onClick={() => {
